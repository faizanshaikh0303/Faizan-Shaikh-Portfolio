...
const EXPERIENCES: Experience[] = [
  ...
  },
  {
    ...
    bullets: [
      'Designed, developed, and launched Java/Spring Boot microservices handling payments and refunds — 5M+ daily requests; migrated to Quarkus reducing resource costs by 30%.',
      'Built distributed backend systems on AWS (ECS, Lambda, RDS, DynamoDB, S3, API Gateway, SNS/SQS) with MySQL and PostgreSQL; optimized complex SQL for financial transaction processing.',
      'Led cloud migration to AWS ECS/Fargate; performed cost analysis via AWS CostExplorer.',
      'Applied OAuth2, JWT, AWS Secrets Manager; implemented distributed tracing and structured logging to reduce MTTR by 30%.',
      'Built CI/CD pipelines (GitLab CI, Jenkins) with JUnit/Mockito/Testcontainers coverage, reducing manual testing by 50%.',
    ],
    tech: 'Java · Spring Boot · Quarkus · AWS (ECS, Lambda, RDS, DynamoDB, S3) · MySQL · PostgreSQL · GitLab CI · Jenkins · OAuth2 · JWT',
  },
  {
    id: 4,
    image: exp4,
